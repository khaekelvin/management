  ...
  return (
    <div className='bg-white py-24 sm:py-32'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 sm:mt-16 sm:pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3'>
          {posts.map((post) => (
            <article
              key={post.id}
            ...
            >
              ...
              <div className='group relative'>
                <h3 className='mt-1 text-lg font-semibold leading-9 text-gray-900 group-hover:text-gray-600'>
                  <a href={post.href}>
